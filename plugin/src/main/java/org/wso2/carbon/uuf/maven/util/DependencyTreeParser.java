...
public class DependencyTreeParser {
     ...
     * @throws MojoExecutionException an error occured when parsing the dependency tree
     */
    public static DependencyNode parse(List<String> dependencyTreeLines) throws MojoExecutionException {
        ...
        for (int i = 1; i < dependencyTreeLines.size(); i++) {
            ...
            if (jump < 0) {
                ...
                throw new MojoExecutionException("Delta between current level (" + level + ") and previous level (" +
